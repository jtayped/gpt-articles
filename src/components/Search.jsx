...
const Search = () => {
  ...
  return (
    <div className="bottom-0 left-0 w-full border-t dark:border-white/20 md:bg-vert-light-gradient bg-white dark:bg-gpt-400 dark:md:bg-vert-dark-gradient pt-2">
      <form
